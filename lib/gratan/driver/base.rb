class Gratan::Driver
  class Base
    ...
    # Version-specific methods that should be overridden in subclasses
    def show_create_user(user, host)
      raise NotImplementedError, "show_create_user must be implemented in subclass"
    end

    def version
      raise NotImplementedError, "version must be implemented in subclass"
    end
